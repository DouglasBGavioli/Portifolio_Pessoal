...
export const ProjectCard = ({ project }: ProjectCardProps) => {
    const technologies = project.technologies.map(techs => techs.name).join(', ')
    ...
    return (
        <div className="rounded-lg h-[436px] flex flex-col bg-gray-800 overflow-hidden border-2 border-gray-800 hover:border-yellow-500 opacity-70 hover:opacity-100 transition-all group">
            ...
            <div className="flex-1 flex flex-col p-7">
                <strong className="font-medium text-gray-50/90 group-hover:text-yellow-500 transition-all">{project.title}</strong>
